...
<template>
    <div class="text-center mt-36">
      <img class="max-h-48 inline-block mb-4" src="../../assets/403.png" alt="error"/>
      <div class="text-[50px]">Access Denied</div>
      <div class="mb-8">You don’t have access to this page</div>
